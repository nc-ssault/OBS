...
OBS::OBS(int nShowCmd = SW_SHOW) // MOD by ssault
{
    App = this;
    ...
    ResizeWindow(false);
    ShowWindow(hwndMain, nShowCmd); // MOD by ssault
    ...
    SetWindowPos(hwndMain, (App->bAlwaysOnTop) ? HWND_TOPMOST : HWND_NOTOPMOST, 0, 0, 0, 0, SWP_NOSIZE | SWP_NOMOVE | SWP_NOACTIVATE); // MOD by ssault
